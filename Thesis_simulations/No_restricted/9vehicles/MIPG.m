...
vel =  [10; 20; 10; 20; 10; 10; 20; 10; 10; 20]; % velociodad inicial
Vdes = [30; 13; 20; 10; 10; 20; 30; 30; 20; 50]; %velocidad deseada

zel =  [6; 1; 3; 5; 2; 4; 6; 4; 3; 5]; %carril inicial
Zdes = [3; 1; 2; 1; 1; 1; 3; 3; 2; 5]; %carril deseado

% zel =  [6; 1; 3; 5; 2; 4; 6; 4; 3; 5; 2; 1]; %carril inicial
% Zdes = [3; 3; 3; 3; 3; 3; 3; 3; 3; 3; 3; 3]; %carril deseado

%--- Initial distances 
pos =  [0 -40 -10 -10 -30 -30 -30 10 10 10]';
vh=9
vel  = vel(1:vh);
Vdes = Vdes(1:vh);
zel  = zel(1:vh);
