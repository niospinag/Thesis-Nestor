...
vel =  [30; 20; 10; 20; 30; 10; 20; 30; 10; 20; 10; 20]; % velociodad inicial
Vdes = [30; 20; 20; 10; 50; 10; 30; 20; 20; 50;  5;  5]; %velocidad deseada

zel =  [2; 5; 4; 6; 4; 3; 6; 3; 4; 1; 6; 5]; %carril inicial
Zdes = [3; 4; 2; 1; 5; 1; 3; 2; 2; 5; 1; 1]; %carril deseado

%--- Initial distances 
pos =  [0 -20 -10 -30 -45 -60 -30 -10 20 10 30 40]';
...
for k = 1:N
    ...
    % Feasible region
    constraints = [constraints,       1 <= z_2 <= L, % take possible values
                                      1 <= z{k+1} <= L,
                                      z{k} - 1 <= z{k + 1},
                                      z{k + 1} <= z{k} + 1];
...
Draw_object(vhist*scale_x , zhist*scale_y + shift_y, vphist*scale_x, zphist*scale_y + shift_y, hist_pos*scale_x + shift_x, T,2)
save('myData.mat','vhist','zhist','vphist','zphist','hist_pos','T', "End", "hist_pos")