...
vel =  [10; 20; 10; 20; 10; 10]; % velociodad inicial
Vdes = [30; 13; 20; 10; 10; 20]; %velocidad deseada

% zel =  [6; 1; 3; 5; 2; 4; 6; 4; 3; 5; 2; 1]; %carril inicial
% Zdes = [3; 1; 2; 1; 1; 1; 3; 3; 2; 5; 1; 2]; %carril deseado

zel =  [6; 1; 3; 5; 2; 4]; %carril inicial
Zdes = [3; 3; 3; 3; 3; 3]; %carril deseado

%--- Initial distances 
pos =  [0 -40 -10 -10 -30 -30]';
